    ...
    <div className="home-content">
      ...
      <div className="text-container">
        <div className="text-content">
          ...
          <p>Vous vous demandez peut-être ce qu'est la sophrologie, en quoi consiste t-elle, et qu'apporte t-elle dans votre quotidien ?</p>
        </div>
      </div>
      <div className="three-columns">
        <div className="column" data-aos="flip-right" data-aos-offset="200">
        ...
        <div className="column middle-column" data-aos="flip-right" data-aos-offset="200">
